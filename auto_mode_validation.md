...
The remaining planned work extends the implemented Stage 12A–12C monitoring
foundation into stability QC, reporting, modeling, and selection. Stages 12D
and later are not present in the current controller or Pi protocol.
