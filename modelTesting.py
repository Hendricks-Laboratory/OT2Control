...
# Visualize
df.plot(kind='scatter', x='sqft', y='price', color='red', label="Data")
plt.scatter(df['sqft'], prediction, color='green', label="Predicted")
...
df.plot(kind='scatter', x='bathrooms', y='price', color='red', label="Data")
plt.scatter(df['bathrooms'], prediction, color='green', label="Predicted")
