...
**Validation:** scalar/vector equivalence tests; backup-switch cases; insufficient-source, insufficient-tip, and reserve-boundary cases; no state mutation during failed preflight.
